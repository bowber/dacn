...
RUN tlmgr install babel-vietnamese tocloft titlesec enumitem multirow tex-gyre pgfplots biblatex

# Install biber and Noto fonts
RUN apt-get update && apt-get install -y biber fonts-noto-core && rm -rf /var/lib/apt/lists/*
