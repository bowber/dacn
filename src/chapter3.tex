...
\begin{tikzpicture}[scale=0.9, transform shape]
    ...
    \node at (8.5,8.2) [font=\normalsize] {Van làm mát};
    
    % Nước làm mát vào
    \draw[->, thick, blue] (9.5,7.5) -- (9,7.5);
    \node at (10.5,7.5) [font=\normalsize, blue] {Nước vào};
    
    % Nước làm mát ra
    \draw[->, thick, red] (5.5,8) -- (5.5,8.5) -- (10,8.5);
    \node at (10.5,8.5) [font=\normalsize, red] {Nước ra};
...
Quy trình hoạt động:
\begin{enumerate}
    \item Hỗn hợp ethanol -- nước (nồng độ 15\% vol) được bơm qua bộ gia nhiệt và đưa vào tháp chưng cất tại mâm thứ 4 (từ dưới lên).
    ...
    \item Một phần sản phẩm ngưng tụ hồi lưu về tháp, phần còn lại là sản phẩm đỉnh (nồng độ mục tiêu 92\% vol).
