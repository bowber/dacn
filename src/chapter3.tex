...
Cảm biến áp suất SITRANS P200 [10] được lắp đặt tại đường ống hơi ra khỏi đỉnh tháp, trước bộ ngưng tụ. Đây là cảm biến áp suất compact với các đặc điểm kỹ thuật:
\begin{itemize}
...
Cảm biến lưu lượng cánh quay thể tích nhỏ Kobold DPM [7] được sử dụng để đo lưu lượng dòng hồi lưu:
\begin{itemize}
...
\hline
\%I0.0 & Auto Mode Switch \\
\%IW96 & Distillate Tank Level \\
\%IW98 & Top Column Pressure \\
\%IW100 & Reflux Flow Rate \\
\%IW102 & Feed Flow Rate \\
\%IW104 & Top Column Temperature \\
\%IW106 & Tray 1 Temperature \\
\%IW108 & Tray 2 Temperature \\
\%IW110 & Tray 3 Temperature \\
\%IW112 & Tray 4 Temperature \\
\%IW114 & Tray 5 Temperature \\
\%IW116 & Tray 6 Temperature \\
\%IW118 & Feed Temperature \\
\%IW120 & Distillate Temperature \\
\%IW122 & Reboiler Temperature \\
\%IW124 & Cooling Water Inlet Temp \\
\%IW126 & Cooling Water Outlet Temp \\
\%IW756 & Reboiler Level \\
\hline
\end{tabular}
...
\textbf{Địa chỉ} & \textbf{Tên tín hiệu} \\
\hline
\%Q0.0 & Distillate Valve Relay \\
\%Q0.1 & Feed Pump Relay \\
\%Q0.2 & Reflux Pump Relay \\
\%Q0.3 & Reboiler Heater Relay 1 \\
\%Q0.4 & Feed Heater Relay \\
\%Q0.5 & Tank Heater Relay \\
\%Q0.6 & Feed Valve Relay \\
\%Q0.7 & Reboiler Heater Relay 2 \\
\%Q1.0 & Cooling Water Valve (On/Off) \\
\%Q1.1 & Reflux Solenoid \\
\%QW128 & Feed Pump Speed Setpoint \\
\%QW130 & Tank Heater Control Signal \\
\%QW132 & Reflux Valve Position \\
\%QW134 & Cooling Valve Position \\
\%QW290 & Reboiler Valve Position \\
\%QW752 & Reflux Pump Speed Setpoint \\
\hline
\end{tabular}
