...
\caption{Sơ đồ PFD hệ thống chưng cất ethanol -- nước}
...
Cảm biến mức điện dung Kobold NMC \cite{kobold_nmc} được lắp đặt tại bình chứa sản phẩm hồi lưu:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Dòng điện tối đa: 420 mA (tại 9 W và 24 V)
...
Khi kết hợp van Type 2873 với bộ điều khiển Type 8605, tín hiệu điều khiển 4-20 mA từ PLC được chuyển đổi thành dòng điện tương ứng để điều chỉnh độ mở van. Type 8605 được cấu hình dải đầu ra phù hợp với Type 2873 (tối đa 420 mA). Tại tín hiệu 20 mA (100\% độ mở), dòng điện đạt khoảng 390 mA.
