...
Cảm biến áp suất SITRANS P200 (Siemens AG, 2021) được lắp đặt tại đường ống hơi ra khỏi đỉnh tháp, trước bộ ngưng tụ. Đây là cảm biến áp suất compact với các đặc điểm kỹ thuật:
\begin{itemize}
...
Lưu lượng kế cánh quay thể tích nhỏ Kobold DPM (KOBOLD Messring GmbH, 2023) được sử dụng để đo lưu lượng dòng hồi lưu:
\begin{itemize}
