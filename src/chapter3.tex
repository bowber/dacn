...
\begin{itemize}
    ...
    \item Dải dòng điện đầu ra: 200 -- 1000 mA (phù hợp với Type 2873)
...
Khi kết hợp van Type 2873 với bộ điều khiển Type 8605 (dải 200-1000 mA), tín hiệu điều khiển 4-20 mA từ PLC được chuyển đổi thành dòng điện cuộn coil tương ứng để điều chỉnh độ mở van. Tại tín hiệu 20 mA (100\% độ mở), dòng điện cuộn coil đạt khoảng 390 mA.
...
Trong phương án vận hành hiện tại, van nước làm mát được mở cố định ở mức 100\% để đảm bảo áp suất đỉnh tháp luôn ổn định, đồng thời reboiler hoạt động ở công suất tối đa (6000 W). Phương án này có ưu điểm là đơn giản, không cần hệ thống điều khiển phức tạp, nhưng gây lãng phí năng lượng đáng kể.
