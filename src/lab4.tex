...
Trong Factory I/O, cảm biến đo mức hoạt động theo nguyên lý \textbf{cảm biến điện dung}:
\begin{itemize}
    \item Cảm biến điện dung đo sự thay đổi điện dung khi mức chất lỏng thay đổi
    \item Điện dung tỉ lệ với diện tích bản cực và hằng số điện môi của môi trường: $C = \varepsilon \frac{A}{d}$
    \item Khi mức chất lỏng tăng, phần điện cực ngập trong chất lỏng tăng, làm thay đổi điện dung
    \item Mạch điện tử chuyển đổi sự thay đổi điện dung thành tín hiệu điện (0-10V)
    \item PLC đọc tín hiệu analog và quy đổi ra giá trị mức (cm hoặc \%)
\end{itemize}

\textbf{Các yếu tố gây nhiễu cho cảm biến đo mức điện dung:}

\begin{enumerate}
    \item \textbf{Thay đổi hằng số điện môi của chất lỏng:}
    \begin{itemize}
        \item Nhiệt độ thay đổi làm hằng số điện môi thay đổi
        \item Thành phần chất lỏng thay đổi (nồng độ, tạp chất)
        \item Khắc phục: Bù nhiệt độ, hiệu chuẩn định kỳ
    \end{itemize}
    
    \item \textbf{Bám cặn trên điện cực:}
    \begin{itemize}
        \item Cặn bẩn bám trên bề mặt điện cực làm sai lệch phép đo
        \item Khắc phục: Vệ sinh định kỳ, dùng lớp phủ chống bám
    \end{itemize}
    ...
    \item \textbf{Bọt khí và sóng trên bề mặt:}
    \begin{itemize}
        \item Bọt khí làm thay đổi hằng số điện môi cục bộ
        \item Sóng trên bề mặt gây dao động tín hiệu
        \item Khắc phục: Lọc tín hiệu, lắp đặt ống giảm chấn
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item Real Games, \textit{Factory I/O Documentation - Tank}. \url{https://docs.factoryio.com/manual/parts/stations/#tank}
\end{enumerate}
