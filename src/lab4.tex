...
Sơ đồ khối tổng quát bao gồm: Giá trị đặt $Y_{SP}$ $\rightarrow$ Bộ điều khiển PID $\rightarrow$ Thiết bị chấp hành $\rightarrow$ Quá trình $\rightarrow$ Cảm biến $\rightarrow$ Phản hồi về bộ điều khiển. Nhiễu tác động vào quá trình.
