...
Nếu $Q_{\text{ngưng tụ}} > Q_{\text{hóa hơi}}$: dịch ngưng bị làm lạnh dưới nhiệt độ sôi (subcooling), lãng phí nước làm mát.
...
\begin{equation}
    \Delta T_{subcool} = T_{\text{đỉnh}} - T_{\text{dịch ngưng}}
\end{equation}

Trong đó:
\begin{itemize}
    \item $T_{\text{đỉnh}}$: Nhiệt độ hơi tại đỉnh tháp (đo bằng cảm biến nhiệt độ đỉnh) $\approx$ 78.4°C
    \item $T_{\text{dịch ngưng}}$: Nhiệt độ dịch ngưng sau condenser (đo bằng cảm biến nhiệt độ dịch ngưng)
\end{itemize}
