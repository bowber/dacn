...
Lưu lượng nước làm mát cần thiết được tính từ cân bằng năng lượng:
\begin{equation}
    Q_{\text{hóa hơi}} = \dot{m}_{water} \cdot C_p \cdot (T_{out} - T_{in})
\end{equation}
...
Để vận hành tối ưu, lưu lượng nước cần thiết phụ thuộc vào nhiệt độ nước ra:
\begin{equation}
...
\textbf{Nguyên lý cân bằng năng lượng:} Lưu lượng nước làm mát được xác định bởi cân bằng năng lượng:
\begin{equation}
