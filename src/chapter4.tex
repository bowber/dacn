...
\hline
\textbf{Chế độ} & \textbf{$T_{out}$} & \textbf{Biên độ} & \textbf{Lưu lượng} & \textbf{Valve} \\
\hline
...
\textbf{Khuyến nghị:} Chọn $T_{out} = 50^\circ$C (biên độ 28$^\circ$C) để đảm bảo an toàn và ổn định. Lưu lượng tương ứng là 3.8 L/min (van 53\%), tiết kiệm 47\% so với baseline.
