...
Trong thiết kế thiết bị trao đổi nhiệt, chênh lệch nhiệt độ tiếp cận (approach temperature) thường nằm trong khoảng 5-15$^\circ$C. Đồ án chọn $\Delta T_{approach} = 10^\circ$C để đảm bảo động lực truyền nhiệt đủ lớn mà vẫn tận dụng được phần lớn khả năng hấp thụ nhiệt của nước làm mát. Với $T_{condensation} = 78^\circ$C:
\begin{equation}
