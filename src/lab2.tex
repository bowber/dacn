...
\hline
D2 & Công tắc (INPUT) & D8 & Van V0 \\
\hline
D3 & Bơm 3 & D9 & Điện trở R2 \\
\hline
D4 & Bơm 2 & D10 & Điện trở R1 \\
\hline
D5 & Bơm 1 & D11 & Điện trở R0 \\
\hline
D6 & Van V2 & & \\
\hline
D7 & Van V1 & & \\
...
void chutrinhON() {
  ...
  // B3: Gia nhiet noi dun (60s)
  digitalWrite(van0, 0); digitalWrite(re0, 1); digitalWrite(van2, 1); delay(60000);
  // B4: Khoi dong dong nhap lieu (10s)
  digitalWrite(van1, 1); digitalWrite(re1, 1); delay(10000);
  // B5: Khoi dong dong hoan luu (10s)
  digitalWrite(pump2, 1); digitalWrite(re2, 1); delay(10000);
...
void setup() {
  ...
  pinMode(pump3, OUTPUT); pinMode(pump2, OUTPUT); pinMode(pump1, OUTPUT);
  pinMode(van2, OUTPUT); pinMode(van1, OUTPUT); pinMode(van0, OUTPUT);
  pinMode(re2, OUTPUT); pinMode(re1, OUTPUT); pinMode(re0, OUTPUT);
}
