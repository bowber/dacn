...
\begin{itemize}
    ...
    \item Khảo sát đặc tính dao động và ảnh hưởng của deadband (dải chết).
\end{itemize}
...
\subsubsection{Khảo sát ảnh hưởng của deadband}
\begin{enumerate}
    \item Thay đổi giá trị deadband: $h$ = 1°C, 2°C, 5°C.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../assets/HMI_TN2.webp}
...
\hline
\textbf{Deadband (°C)} & \textbf{Biên độ dao động (°C)} & \textbf{Chu kỳ dao động (s)} & \textbf{Tần số đóng ngắt} \\
\hline
...
\hline
\end{tabular}
\caption{Kết quả khảo sát ảnh hưởng của deadband}
\end{table}
...
\subsubsection{Ảnh hưởng của deadband đến chất lượng điều khiển}
