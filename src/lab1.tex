...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[sum, right=1.2cm of gv] (sum2) {};
    ...
    % Sum signs - positioned in gaps between × lines (N, S, E, W)
    \node[font=\tiny] at ($(sum.west)+(0.18,0)$) {$+$};
    \node[font=\tiny] at ($(sum.south)+(0,0.18)$) {$-$};
    \node[font=\tiny] at ($(sum2.west)+(0.18,0)$) {$+$};
    \node[font=\tiny] at ($(sum2.north)+(0,-0.18)$) {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \node[sum, right=1cm of gc] (sum2) {};
    \node[block, right=1cm of sum2] (gv) {$G_V$};
    \node[sum, right=1cm of gv] (sum3) {};
    ...
    % Sum signs - positioned in gaps between × lines (N, S, E, W)
    \node[font=\tiny] at ($(sum1.west)+(0.18,0)$) {$+$};
    \node[font=\tiny] at ($(sum1.south)+(0,0.18)$) {$-$};
    \node[font=\tiny] at ($(sum2.south)+(0,0.18)$) {$+$};
    \node[font=\tiny] at ($(sum2.west)+(0.18,0)$) {$+$};
    \node[font=\tiny] at ($(sum3.west)+(0.18,0)$) {$+$};
    \node[font=\tiny] at ($(sum3.north)+(0,-0.18)$) {$+$};
\end{tikzpicture}
