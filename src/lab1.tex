...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[font=\scriptsize] at ($(sum.south)+(0,-0.4)$) [right] {$-$};
    \node[font=\scriptsize] at ($(gv.east)!0.5!(sum2.west)$) [above] {$+$};
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \node[font=\scriptsize] at ($(sum1.south)+(0,-0.4)$) [right] {$-$};
    \node[font=\scriptsize] at ($(gff.south)!0.5!(sum2.north)$) [right] {$+$};
    \node[font=\scriptsize] at ($(gc.east)!0.5!(sum2.west)$) [above] {$+$};
    \node[font=\scriptsize] at ($(gv.east)!0.5!(sum3.west)$) [above] {$+$};
