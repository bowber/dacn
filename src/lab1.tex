...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[font=\scriptsize] at ($(gv.east)!0.3!(sum2.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(gd.south)!0.5!(sum2.north)$) [left] {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    % Sum signs - positioned outside circle, below arrow lines
    \node[font=\scriptsize] at ($(gff.south)!0.5!(sum.north)$) [left] {$+$};
    \node[font=\scriptsize] at ($(sp.east)!0.5!(sum.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(gv.east)!0.3!(sum2.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(gd.south)!0.5!(sum2.north)$) [left] {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    % Sum signs - positioned outside circle, below arrow lines
    \node[font=\scriptsize] at ($(sp.east)!0.5!(sum1.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(sum1.south)+(0,-0.5)$) [left] {$-$};
    \node[font=\scriptsize] at ($(gff.south)!0.5!(sum2.north)$) [left] {$+$};
    \node[font=\scriptsize] at ($(gc.east)!0.3!(sum2.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(gv.east)!0.3!(sum3.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(gd.south)!0.5!(sum3.north)$) [left] {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=2cm]
    ...
    % Sum signs - positioned outside circle, below arrow lines
    \node[font=\scriptsize] at ($(sp.east)!0.3!(sum.west)$) [below] {$+$};
    \node[font=\scriptsize] at ($(sum.south)+(0,-0.5)$) [left] {$-$};
\end{tikzpicture}
