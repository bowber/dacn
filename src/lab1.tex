...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    % Sensor - centered between sum and output
    \coordinate (center) at ($(sum)!0.5!(output)$);
    \node[block, below=1cm of center] (sensor) {Cảm biến nhiệt độ};
    ...
    \draw[line] (fb) |- (sensor);
    \draw[arrow] (sensor) -| (sum) node[pos=0.95, left, font=\small] {$-$};
