...
\begin{itemize}
    ...
    \item \textbf{Startdrive:} Cấu hình biến tần
\end{itemize}
...
\begin{enumerate}
    ...
    \item Cấu hình module analog input để đọc tín hiệu từ cảm biến Pt100.
    \item Tạo tag cho biến nhiệt độ (PV - Process Value).
\end{enumerate}

\subsubsection{Thiết kế giao diện HMI}
\begin{enumerate}
    \item Thêm màn hình HMI vào project (có thể dùng PC Station hoặc panel ảo).
...
\begin{enumerate}
    ...
    \item Chạy Runtime HMI và quan sát giá trị nhiệt độ hiển thị.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Startdrive: Cấu hình biến tần
\end{itemize}
