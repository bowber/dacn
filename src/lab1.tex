...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[font=\tiny] at ($(sum2.north west)+(0.12,-0.12)$) {$+$};
    \node[font=\tiny] at ($(sum2.north east)+(-0.12,-0.12)$) {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    % Sum signs - positioned in quadrants between cross lines
    \node[font=\tiny] at ($(sum1.north west)+(0.12,-0.12)$) {$+$};
    \node[font=\tiny] at ($(sum1.south west)+(0.12,0.12)$) {$-$};
    \node[font=\tiny] at ($(sum2.south west)+(0.12,0.12)$) {$+$};
    \node[font=\tiny] at ($(sum2.north west)+(0.12,-0.12)$) {$+$};
    \node[font=\tiny] at ($(sum3.north west)+(0.12,-0.12)$) {$+$};
    \node[font=\tiny] at ($(sum3.north east)+(-0.12,-0.12)$) {$+$};
\end{tikzpicture}
