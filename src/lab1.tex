...
\begin{tikzpicture}[node distance=1.8cm]
    % Nodes
    \node (sp) {$Y_{SP}$};
    \node[sumcircle, right=1cm of sp] (sum) {};
    \node[block, right=1.2cm of sum] (gc) {$G_C$};
    \node[block, right=1.2cm of gc] (gv) {$G_V$};
    \node[sumcircle, right=1.2cm of gv] (sum2) {};
    \node[block, right=1.2cm of sum2] (gp) {$G_P$};
    \node[right=1.5cm of gp] (output) {$Y$};
    
    % Disturbance
    \node[block, above=0.8cm of sum2] (gd) {$G_D$};
    \node[above=0.6cm of gd] (dist) {$Z$};
    
    % Sensor
    \node[block, below=1cm of gp] (gm) {$G_M$};
    ...
    % Sum signs
    \node[font=\tiny] at ($(sum.north west)+(0.15,-0.15)$) {$+$};
    \node[font=\tiny] at ($(sum.south west)+(0.15,0.15)$) {$-$};
    \node[font=\tiny] at ($(sum2.north)+(0,-0.2)$) {$+$};
    \node[font=\tiny] at ($(sum2.west)+(0.2,0)$) {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.8cm]
    % Nodes
    \node (sp) {$Y_{SP}$};
    \node[sumcircle, right=1.5cm of sp] (sum) {};
    \node[block, right=1.2cm of sum] (gv) {$G_V$};
    \node[sumcircle, right=1.2cm of gv] (sum2) {};
    \node[block, right=1.2cm of sum2] (gp) {$G_P$};
    \node[right=1.5cm of gp] (output) {$Y$};
    
    % Feedforward controller
    \node[block, above=1.2cm of sum] (gff) {$G_{FF}$};
    
    % Disturbance
    \node[block, above=0.8cm of sum2] (gd) {$G_D$};
    \node[above=0.6cm of gd] (dist) {$Z$};
    
    % Sensor for disturbance
    \node[block, left=0.8cm of gff] (gm) {$G_M$};
    ...
    % Sum signs
    \node[font=\tiny] at ($(sum.south)+(0,0.2)$) {$+$};
    \node[font=\tiny] at ($(sum.north)+(0,-0.2)$) {$+$};
    \node[font=\tiny] at ($(sum2.north)+(0,-0.2)$) {$+$};
    \node[font=\tiny] at ($(sum2.west)+(0.2,0)$) {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=1.5cm]
    % Nodes
    \node (sp) {$Y_{SP}$};
    \node[sumcircle, right=1cm of sp] (sum1) {};
    \node[block, right=1cm of sum1] (gc) {$G_C$};
    \node[sumcircle, right=1cm of gc] (sum2) {};
    \node[block, right=1cm of sum2] (gv) {$G_V$};
    \node[sumcircle, right=1cm of gv] (sum3) {};
    \node[block, right=1cm of sum3] (gp) {$G_P$};
    \node[right=1.5cm of gp] (output) {$Y$};
    
    % Feedforward controller
    \node[block, above=1cm of sum2] (gff) {$G_{FF}$};
    
    % Disturbance
    \node[block, above=0.8cm of sum3] (gd) {$G_D$};
    \node[above=0.5cm of gd] (dist) {$Z$};
    
    % Sensors
    \node[block, left=0.6cm of gff] (gmz) {$G_{MZ}$};
    \node[block, below=1.2cm of gp] (gmy) {$G_{MY}$};
    ...
    % Sum signs
    \node[font=\tiny] at ($(sum1.north west)+(0.15,-0.15)$) {$+$};
    \node[font=\tiny] at ($(sum1.south west)+(0.15,0.15)$) {$-$};
    \node[font=\tiny] at ($(sum2.south)+(0,0.2)$) {$+$};
    \node[font=\tiny] at ($(sum2.north)+(0,-0.2)$) {$+$};
    \node[font=\tiny] at ($(sum3.north)+(0,-0.2)$) {$+$};
    \node[font=\tiny] at ($(sum3.west)+(0.2,0)$) {$+$};
\end{tikzpicture}
...
\begin{tikzpicture}[node distance=2cm]
    % Nodes
    \node (sp) {$Y_{SP}$};
    \node[sumcircle, right=1.2cm of sp] (sum) {};
    \node[block, right=1.5cm of sum, minimum width=4em] (controller) {Bộ điều khiển};
    ...
    % Sensor
    \node[block, below=1.2cm of process, minimum width=4em] (sensor) {Cảm biến};
