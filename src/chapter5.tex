...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Tính toán công suất reboiler tối ưu với PWM: 3066 W (duty cycle 51\%).
        \item So sánh ba phương án vận hành: baseline, điều khiển van, và PWM + van.
    \end{itemize}
\end{enumerate}
...
\hline
Công suất reboiler & 6000 W & 6000 W & 3066 W \\
\hline
Độ mở van & 100\% & 53\% & ~33\% \\
\hline
Lưu lượng nước & 7.2 L/min & 3.8 L/min & ~2.4 L/min \\
\hline
Tiết kiệm điện & -- & 0\% & 49\% \\
\hline
...
\begin{itemize}
    ...
    \item \textbf{Điều khiển PWM reboiler:} Tiết kiệm thêm 49\% điện năng reboiler bằng cách giảm công suất xuống mức cần thiết.
    \item \textbf{Kết hợp cả hai:} Tiết kiệm ~67\% nước làm mát và 49\% điện năng so với vận hành baseline.
