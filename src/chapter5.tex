...
\hline
3--4 & Thiết kế bộ điều khiển PID, lập trình PLC S7-1200 (TIA Portal), thiết kế HMI \\
\hline
5--6 & Thí nghiệm vòng điều khiển áp suất PC-01, thu thập dữ liệu, tinh chỉnh PID \\
\hline
7--8 & Triển khai điều khiển PWM reboiler, đánh giá hiệu quả tiết kiệm năng lượng \\
\hline
9 & Hoàn thiện báo cáo, chuẩn bị bảo vệ đồ án \\
\hline
\end{tabular}
