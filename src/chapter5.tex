...
\begin{enumerate}
    ...
    \item \textbf{Phân tích độ nhạy hiệu suất mâm Murphree:} Tỷ số hồi lưu vận hành $R = 10.4$ được tính toán với giả định hiệu suất mâm Murphree $E_{MV} = 80\%$. Tuy nhiên, trong thực tế hiệu suất mâm có thể dao động trong khoảng 70--80\% tùy thuộc vào điều kiện vận hành (lưu lượng, nhiệt độ, tình trạng thiết bị). Bảng \ref{tab:sensitivity_EMV} cho thấy ảnh hưởng của $E_{MV}$ đến tỷ số hồi lưu cần thiết:
    ...
    \item \textbf{Phân tích độ nhạy hệ số truyền nhiệt:} Kết quả tính toán phụ thuộc vào hệ số truyền nhiệt tổng $U$ của thiết bị ngưng tụ. Giá trị $U_{ref} = 800$ W/(m²·K) được sử dụng trong tính toán dựa trên dữ liệu từ Engineering ToolBox cho hệ thống ngưng tụ hơi hữu cơ với nước làm mát (300--1200 W/(m²·K)). Bảng \ref{tab:sensitivity_U} cho thấy kết quả thay đổi đáng kể theo giá trị $U_{ref}$:
...
\hline
1 & 23/12 -- 29/12/2024 & Nghiên cứu tài liệu, tìm hiểu hệ thống chưng cất thực tế & \\
\hline
2 & 30/12/2024 -- 05/01/2025 & Xây dựng mô hình toán học, phân tích McCabe-Thiele & \\
\hline
3 & 06/01 -- 12/01/2025 & Lập trình mô phỏng Python, thiết kế bộ điều khiển PID & \\
\hline
4 & 13/01 -- 19/01/2025 & Hoàn thiện mô phỏng, viết báo cáo đồ án chuyên ngành & \\
\hline
5--6 & 20/01 -- 02/02/2025 & Dự phòng cho chỉnh sửa và bổ sung & \\
\hline
7--8 & 03/02 -- 16/02/2025 & Lập trình PLC S7-1200 (TIA Portal), thiết kế HMI & \\
\hline
9--10 & 17/02 -- 02/03/2025 & Thí nghiệm thực tế, thu thập dữ liệu vận hành & \\
\hline
11--12 & 03/03 -- 16/03/2025 & Tinh chỉnh thông số PID trên thiết bị thực & \\
\hline
13--14 & 17/03 -- 30/03/2025 & Dự phòng cho thí nghiệm bổ sung và xử lý số liệu & \\
\hline
15 & 31/03 -- 06/04/2025 & Hoàn thiện báo cáo, chuẩn bị bảo vệ đồ án & \\
\hline
\end{tabular}
