...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Đề xuất phương pháp xác định duty cycle PWM tối ưu cho reboiler bằng thực nghiệm.
        \item So sánh các phương án vận hành: baseline, điều khiển van, và PWM + van.
    \end{itemize}
\end{enumerate}
...
\hline
\textbf{Thông số} & \textbf{Baseline} & \textbf{Điều khiển van} & \textbf{PWM + Van} \\
\hline
Công suất reboiler & 6000 W & 6000 W & TBD (thực nghiệm) \\
\hline
Độ mở van & 100\% & 53\% & TBD \\
\hline
Lưu lượng nước & 7.2 L/min & 3.8 L/min & TBD \\
\hline
Tiết kiệm điện & -- & 0\% & ước tính 30--50\% \\
\hline
Tiết kiệm nước & -- & 47\% & $>$47\% \\
\hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Điều khiển PWM reboiler:} Tiềm năng tiết kiệm 30--50\% điện năng reboiler, duty cycle tối ưu sẽ được xác định qua thực nghiệm.
    \item \textbf{Kết hợp cả hai:} Khi giảm công suất reboiler, lượng hơi giảm, bộ điều khiển PC-01 tự động giảm thêm độ mở van, tiết kiệm thêm nước làm mát.
