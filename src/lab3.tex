...
\begin{enumerate}
    \item Điều khiển hệ thống bằng relay (bang-bang control) quanh setpoint
...
\textbf{Câu 1: Trình bày các bước chỉnh định PID theo phương pháp Relay (Åström-Hägglund)?}

Phương pháp Relay (Åström-Hägglund, 1984):
\begin{enumerate}
    \item Điều khiển hệ thống bằng relay (ON/OFF) quanh setpoint
    \item Đo chu kỳ dao động $T_u$ và biên độ dao động $a$ của biến quá trình
    \item Tính ultimate gain theo công thức: $K_u = \frac{4d}{\pi a}$ (với $d$ là biên độ relay)
    \item Áp dụng bảng Ziegler-Nichols để tính thông số PID:
    \begin{itemize}
