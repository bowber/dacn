...
\begin{tikzpicture}
    ...
    \draw[->] (-1,0) -- (1.5,0) node[right] {$e$};
    \draw[->] (0,-1) -- (0,1.5) node[above] {$u$};
    \draw[thick] (-0.8,-0.6) -- (0,-0.6) -- (0,0.8) -- (1.2,0.8);
    \node[font=\small] at (1.5,0.8) {$u_{max}$};
    \node[font=\small] at (1.5,-0.6) {$u_{min}$};
\end{tikzpicture}
