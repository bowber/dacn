...
\hline
P & 100s & -- & 0\% & Có ($e_{ss} \approx 19$) \\
\hline
PI & 203s & -- & 3.6\% & Nhỏ ($e_{ss} \approx -4$) \\
\hline
PID & 111s & -- & 0.2\% & Nhỏ ($e_{ss} \approx 3$) \\
\hline
\end{tabular}
...
\begin{itemize}
    \item \textbf{Bộ điều khiển P:} Có thời gian xác lập nhanh nhất (100s), nhưng tồn tại sai lệch tĩnh ($e_{ss} \approx 19$) do thiếu thành phần tích phân.
    \item \textbf{Bộ điều khiển PI:} Triệt tiêu được sai lệch tĩnh nhờ thành phần tích phân, nhưng thời gian xác lập dài nhất (203s) và có độ quá điều chỉnh 3.6\%.
    \item \textbf{Bộ điều khiển PID:} Cho kết quả cân bằng với thời gian xác lập ngắn (111s), độ quá điều chỉnh rất nhỏ (0.2\%), và sai lệch tĩnh gần như triệt tiêu ($e_{ss} \approx 3$).
\end{itemize}
...
\begin{itemize}
    ...
    \item Bộ điều khiển PID cho chất lượng điều khiển tốt nhất với thời gian xác lập ngắn và sai lệch tĩnh nhỏ.
\end{itemize}
