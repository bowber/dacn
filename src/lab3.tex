...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[font=\scriptsize] at ($(sum.south)+(0,-0.3)$) [right] {$-$};
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    % Sum signs - positioned outside circle, next to arrow lines
    \node[font=\scriptsize] at ($(P.east)!0.5!(sum.west)+(0,0.6)$) {$+$};
    \node[font=\scriptsize] at ($(I.east)!0.5!(sum.west)$) [above] {$+$};
    \node[font=\scriptsize] at ($(D.east)!0.5!(sum.west)+(0,-0.6)$) {$+$};
\end{tikzpicture}
