...
\begin{itemize}
    \item \textbf{Bộ điều khiển P:} Có thời gian xác lập nhanh (100s), nhưng tồn tại sai lệch tĩnh ($e_{ss} \approx 19$) do thiếu thành phần tích phân.
    ...
    \item \textbf{Bộ điều khiển PID:} Cho kết quả tốt nhất với thời gian xác lập ngắn nhất (111s), độ quá điều chỉnh rất nhỏ (0.2\%), và sai lệch tĩnh gần như triệt tiêu ($e_{ss} \approx 3$).
\end{itemize}
