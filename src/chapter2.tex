...
Phương pháp McCabe-Thiele [4] là phương pháp đồ thị để xác định số mâm lý thuyết cần thiết cho quá trình chưng cất. Phương pháp này dựa trên hai giả thiết đơn giản hóa:
\begin{itemize}
...
Với hệ ethanol--nước, nhiệt hóa hơi của ethanol (38.56 kJ/mol) và nước (40.66 kJ/mol) chênh lệch khoảng 5\%, nằm trong phạm vi chấp nhận được cho phương pháp McCabe-Thiele (thường $<$10\%) [4].
...
Với mâm xuyên lỗ trong công nghiệp, $E_{MV}$ thường nằm trong khoảng 70--80\% [4]. Số mâm thực tế cần thiết:
\begin{equation}
...
\begin{itemize}
    ...
    \item $L$: Lưu lượng hồi lưu (đo qua cảm biến lưu lượng)
