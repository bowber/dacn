...
% Điểm đẳng phí
\node[fill=white, font=\small] at (axis cs:0.85, 79) {Điểm đẳng phí};
...
% ------------------------------------------------------------
\subsection{Cơ sở lý thuyết tối ưu hoá năng lượng}
% ------------------------------------------------------------
...
\subsubsection{Các phương pháp tối ưu hoá năng lượng}
...
Ước tính năng lượng tiết kiệm được:
\begin{equation}
    \Delta Q_R = Q_{R,100\%} - Q_{R,optimal} = Q_{C,100\%} - Q_{C,optimal}
\end{equation}

Trong đó:
\begin{itemize}
    \item $Q_{R,100\%}$: Năng lượng reboiler khi van làm mát mở 100\%
    \item $Q_{R,optimal}$: Năng lượng reboiler khi vận hành tối ưu
    \item $Q_{C,100\%}$, $Q_{C,optimal}$: Công suất làm mát tương ứng
\end{itemize}

Hiệu suất tiết kiệm năng lượng:
\begin{equation}
    \eta_{saving} = \frac{\Delta Q_R}{Q_{R,100\%}} \times 100\%
\end{equation}
