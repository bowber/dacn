...
Do có điểm đẳng phí, chưng cất thông thường không thể thu được ethanol tinh khiết 100\%. Nồng độ tối đa đạt được bằng chưng cất thông thường là khoảng 95.6\% mol (tương đương khoảng 95.6\% vol hay 95.6$^\circ$). Mục tiêu sản phẩm đỉnh 92\% vol (92$^\circ$) của đồ án hoàn toàn khả thi vì nằm dưới giới hạn đẳng phí.
