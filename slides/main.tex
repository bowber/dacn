...
\begin{frame}{Cơ sở lý thuyết -- Cân bằng lỏng-hơi}
    ...
    \begin{tikzpicture}
        % Shadow for chart
        \fill[darkblue] (4pt, -4pt) rectangle ++(0.75\textwidth, -5.8cm);
        % Chart background
        \fill[white] (0, 0) rectangle ++(0.75\textwidth, -5.8cm);
        \draw[darkblue, line width=2pt] (0, 0) rectangle ++(0.75\textwidth, -5.8cm);
