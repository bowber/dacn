...
\begin{frame}{Nội dung trình bày}
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            \begin{tikzpicture}
                % Box first to get dimensions
                \node[rectangle, fill=bkblue, draw=darkblue, line width=2pt, inner sep=12pt, text width=0.9\textwidth, anchor=north west] (kltn) at (0,0) {
                    \color{white}
                    ...
                    \begin{enumerate}
                        ...
                        \item Thí nghiệm PC-01
                        \item PWM Reboiler
                        \item Kế hoạch 12 tuần
                    \end{enumerate}
                };
                % Shadow behind (draw after but with background layer)
                \begin{scope}[on background layer]
                    \fill[black] ([xshift=4pt,yshift=-4pt]kltn.north west) rectangle ([xshift=4pt,yshift=-4pt]kltn.south east);
                \end{scope}
            \end{tikzpicture}
        \end{column}
    \end{columns}
